...
tk.Radiobutton(frame1, text="Pocztówka", variable=rodzaj, value="Pocztówka").pack(anchor="w")
tk.Radiobutton(frame1, text="List", variable=rodzaj, value="List").pack(anchor="w")
tk.Radiobutton(frame1, text="Paczka", variable=rodzaj, value="Paczka").pack(anchor="w")
btn_cena = tk.Button(root, text="Sprawdź Cenę", command=update_price)
